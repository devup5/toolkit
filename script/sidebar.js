  ...
  return `
    <aside class="sidebar" id="sidebar">
      <div class="sidebar-top">
        <button type="button" class="sidebar-logo" data-nav="//devup5.github.io/toolkit/home">
          <span class="logo-mark">&lt;/&gt;</span>
          <span class="logo-name">Portfolio</span>
        </button>
      </div>
      <nav class="sidebar-nav">
        <button type="button" class="sidebar-link ${isNav('home')}" data-nav="//devup5.github.io/toolkit/home#home">
        ...
        <button type="button" class="sidebar-link ${isNav('about')}" data-nav="//devup5.github.io/toolkit/home#about">
        ...
        <button type="button" class="sidebar-link ${isNav('changelog')}" data-nav="//devup5.github.io/toolkit/home#changelog">
        ...
        <div class="sidebar-dropdown open" id="dropdownCompile">
          ...
          <div class="sidebar-dropdown-menu">
            <button type="button" class="sidebar-sublink ${isNav('php')}" data-nav="//devup5.github.io/toolkit/tools#php">
            ...
            <button type="button" class="sidebar-sublink ${isNav('typescript')}" data-nav="//devup5.github.io/toolkit/tools#typescript">
            ...
            <button type="button" class="sidebar-sublink ${isNav('python')}" data-nav="//devup5.github.io/toolkit/tools#python">
        ...
        <div class="sidebar-dropdown open" id="dropdownEditor">
          ...
          <div class="sidebar-dropdown-menu">
            <button type="button" class="sidebar-sublink ${isNav('html')}" data-nav="//devup5.github.io/toolkit/tools#html">
            ...
            <button type="button" class="sidebar-sublink ${isNav('css')}" data-nav="//devup5.github.io/toolkit/tools#css">
            ...
            <button type="button" class="sidebar-sublink ${isNav('javascript')}" data-nav="//devup5.github.io/toolkit/tools#javascript">
            ...
            <button type="button" class="sidebar-sublink ${isNav('markdown')}" data-nav="//devup5.github.io/toolkit/tools#markdown">
        ...
        <div class="sidebar-dropdown open" id="dropdownFrontend">
          ...
          <div class="sidebar-dropdown-menu">
            <button type="button" class="sidebar-sublink ${isNav('css-fmt')}" data-nav="//devup5.github.io/toolkit/tools#css-fmt">
            ...
            <button type="button" class="sidebar-sublink ${isNav('base64')}" data-nav="//devup5.github.io/toolkit/tools#base64">
      ...
      <div class="sidebar-bottom">
        <div class="sidebar-links">
          ...
          <button type="button" class="sidebar-icon-btn" data-nav="//devup5.github.io/toolkit/home#about" title="关于我">
...
function initHomeSidebarSync() {
  ...
  window.addEventListener('hashchange', function() {
    ...
    var link = document.querySelector('.sidebar-link[data-nav="//devup5.github.io/toolkit/home#' + nav + '"]');
